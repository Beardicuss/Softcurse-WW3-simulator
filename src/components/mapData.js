...
// ── TERRAIN TYPES ─────────────────────────────────────────────────────────────
// Effects applied in doCombat: mountains/forests boost defender, deserts/plains boost attacker
export const TERRAIN_TYPES = {
    plains:    { id: 'plains',    label: 'Plains',    emoji: '🌾', atkMod: 1.10, defMod: 0.90, supplyMod: 1.0 },
    forest:    { id: 'forest',    label: 'Forest',    emoji: '🌲', atkMod: 0.85, defMod: 1.20, supplyMod: 0.9 },
    mountain:  { id: 'mountain',  label: 'Mountain',  emoji: '⛰',  atkMod: 0.70, defMod: 1.40, supplyMod: 0.7 },
    desert:    { id: 'desert',    label: 'Desert',    emoji: '🏜',  atkMod: 1.05, defMod: 0.85, supplyMod: 0.8 },
    urban:     { id: 'urban',     label: 'Urban',     emoji: '🏙',  atkMod: 0.80, defMod: 1.30, supplyMod: 1.0 },
    coastal:   { id: 'coastal',   label: 'Coastal',   emoji: '🌊', atkMod: 1.0,  defMod: 1.0,  supplyMod: 1.1 },
    tundra:    { id: 'tundra',    label: 'Tundra',    emoji: '🧊', atkMod: 0.75, defMod: 1.10, supplyMod: 0.6 },
    jungle:    { id: 'jungle',    label: 'Jungle',    emoji: '🌴', atkMod: 0.80, defMod: 1.25, supplyMod: 0.75 },
};

// Terrain assignment for all 46 regions
...
export function getTerrain(regionId) {
    return TERRAIN_TYPES[REGION_TERRAIN[regionId] || 'plains'];
}
