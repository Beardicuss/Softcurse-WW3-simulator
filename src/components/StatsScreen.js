...
const StatsScreen = ({ onClose, isGameOver = false }) => {
    ...
    const LABELS = {
        ...
        ge: {
            title:          'საბრძოლო სტატისტიკა',
            combat:         'საბრძოლო ჩანაწერი',
            attacks:        'შეტევები განხორციელდა',
            won:            'შეტევები მოგებული',
            lost:           'შეტევები წაგებული',
            winRate:        'გამარჯვების მაჩვენებელი',
            unitsKilled:    'განადგურებული ნაწილები',
            unitsLost:      'დაკარგული ნაწილები',
            nukes:          'ბირთვული გაშვებები',
            orbitals:       'ორბიტალური დარტყმები',
            territory:      'ტერიტორიული კონტროლი',
            captures:       'დაპყრობილი რეგიონები',
            losses:         'დაკარგული რეგიონები',
            peakRegions:    'მაქს. რეგიონები',
            currentRegions: 'მიმდინარე რეგიონები',
            totalRegions:   'სულ რეგიონები',
            production:     'წარმოება',
            infantry:       'ქვეითი მომზადებული',
            armor:          'ჯავშანი განლაგებული',
            air:            'ავიაესკადრილები',
            naval:          'საზღვაო ნაწილები',
            intelligence:   'დაზვერვა',
            reveals:        'გამჟღავნებები',
            sabotages:      'დივერსიები',
            assassinations: 'ლიკვიდაციები',
            sanctions:      'გამოყენებული სანქციები',
            campaign:       'კამპანია',
            turnsPlayed:    'გადარჩენილი მოლოდინები',
            actReached:     'მიღწეული აქტი',
            peakStability:  'მაქს. სტაბილურობა',
            lowStability:   'მინ. სტაბილურობა',
            missions:       'შესრულებული მისიები',
            close:          'დახურვა',
        }
    };
